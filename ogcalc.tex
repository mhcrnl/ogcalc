...
\usepackage[pdftex,
  pdftitle={An introduction to programming with GTK+ and Glade in ISO C,
  ISO C++ and Python},
  pdfauthor={Roger Leigh},
  pdfsubject={GTK+},
  pdfkeywords={GTK+, Glade, C, C++, Python, GNU, Linux},
  a4paper,raiselinks,
  bookmarks,
  pdfstartview={FitH},
]
...
\title{An introduction to programming with GTK+ and Glade in ISO C,
  ISO C++ and Python\\\bigskip\large{Version 1.3.0}}
...
\lstinputlisting[language=Python,
                 caption={\filename{python/plain/ogcalc}},
                 firstline=26, lastline=333]
                 {python/plain/ogcalc}

\lstinputlisting[language=Python,
                 caption={\filename{python/glade/ogcalc}},
