...
\title{An introduction to programming with GTK+ and Glade in ISO C and
  ISO C++\\\bigskip\large{Version 1.2.1}}
...
c++ `pkg-config --cflags libglademm-2.0` -c ogcalc-main.cc
c++ `pkg-config --libs libglademm-2.0` -o ogcalc ogcalc.o \
                                          ogcalc-main.o
\end{verbatim}
